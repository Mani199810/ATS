     ...
     smtpTransport.sendMail({
        ...
        html:`
                <div style="margin: 20px;">
                    ...
                    <p>hello We are Be practical pvt ltd.  Your selected front end developer position in our organization, We are pleased to offer you the position of  ${req.body.position}. Pls find the attached the details of the Offer letter.</p>
